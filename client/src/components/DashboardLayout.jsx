        ...
        <div className="flex flex-col h-full m-4  justify-between overflow-y-auto">
          <div>
            ...
            {/* <div className="flex items-center justify-between mb-6"> */}
              <div className="w-25 h-14 ml-2 flex items-center justify-start border-b-2 pb-4">
          ...
          <div className="pt-4 border-t dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400">
            <div className="hidden sm:block">© {new Date().getFullYear()} EduVerse - AI-Powered Learning</div>
            <div className="sm:hidden text-center">EduVerse</div>
          </div>
        </div>
      </div>
